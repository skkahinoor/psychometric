...
@section('content')
    ...
    <div class="container py-5">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-5">
            ...
            <div>
                @php
                    $isInstituteViewer = isset($viewerContext) && $viewerContext === 'institute' && isset($viewStudentId);
                @endphp
                @if ($isInstituteViewer)
                    <a href="{{ route('institutestudent.report', $viewStudentId) }}" target="_blank" class="btn btn-primary me-2">View Full Report</a>
                    {{-- <a href="{{ route('institutestudent.report.pdf', $viewStudentId) }}" target="_blank" class="btn btn-dark">Download PDF</a> --}}
                @else
