...
<body>
    <header style="padding:10px">
        <a href="#">
            <img style="max-height: 60px;padding-bottom:10px"
                src="https://thecareermap.in/assets/images/general/logo_white.png" alt="Identity">
        </a>
        @if (Route::has('login'))
    ...
    <div
        class="relative bg-[#2a4a56] min-h-screen flex flex-col items-center justify-center px-4 py-12 text-white text-center">
        <h1
            style="color: white;
    margin-inline: auto;
    width: 70%;
    ...
    opacity: 1;">
        ...
        <button
            class="relative bg-red-500 hover:bg-red-600 text-white font-semibold rounded px-6 py-2 mb-12 drop-shadow-md"
            type="button">
            Request a Call Back
        </button>
        <div
            class="relative flex flex-col sm:flex-row justify-center gap-12 max-w-4xl w-full text-left text-white text-xs sm:text-sm">
        ...
        <div class="fixed right-4 bottom-4 flex flex-col gap-3 z-50">
            <button aria-label="WhatsApp"
                class="w-12 h-12 rounded-full bg-green-500 text-white flex items-center justify-center shadow-lg">
