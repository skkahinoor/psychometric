                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.student.report', $student->id) }}" target="_blank" class="btn btn-sm btn-outline-primary action-btn" data-bs-toggle="tooltip" title="View Report">
                                    <i class="bi bi-file-earmark-text"></i>
                                </a>
                                {{-- <a href="{{ route('admin.student.report.pdf', $student->id) }}" target="_blank" class="btn btn-sm btn-outline-dark action-btn" data-bs-toggle="tooltip" title="Download PDF">
